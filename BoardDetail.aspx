<%@ Page Language="C#" AutoEventWireup="true" CodeFile="BoardDetail.aspx.cs" Inherits="BoardDetail" %>
                ...
                <div class="contents">
                    ...
                    <div class="board_detail_section">
                        <div>
                            ...
                            <asp:Label runat="server" ID="userFileTag" CssClass="board_list_userfiletag icon icon-clip" />
                            <asp:Label runat="server" ID="newTag" CssClass="board_list_newtag" Text="N" />
                        </div>
                        <div>
                            <asp:Label runat="server" ID="gukName" /><asp:Label runat="server" ID="koreName" />
                            <asp:Label runat="server" ID="emplCode" Visible="false" />
                        </div>
                        <div>
                            <asp:Label runat="server" ID="id" CssClass="board_detail_id" />
                            <asp:Label runat="server" ID="hits" CssClass="board_detail_hits" />
                    ...
                    <div style="margin-top: 5px;">
                        <asp:HyperLink runat="server" ID="prevId" CssClass="board_detail_section ellipsis" />
                        <asp:HyperLink runat="server" ID="nextId" CssClass="board_detail_section ellipsis" />
                    </div>
                </div>
            </div>
        </div>
